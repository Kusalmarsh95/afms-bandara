    ...
    <div class="container-fluid">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right m-1">
                            <li class="breadcrumb-item">
                                @if ($membership->altering == 1)
                                    <a href="{{ route('membership-changes') }}" class="btn btn-sm btn-dark">Back</a>
                                @elseif ($membership->rejectedl2 == 1)
                                    <a href="{{ route('membership-rejects') }}" class="btn btn-sm btn-dark">Back</a>
                                @else
        ...
        <div class="card">
            <div class="card-header">
                <div class="container-fluid">
                    <form action="{{ route('approval', ['membership' => $membership->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-header">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="col-6 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="telephone_mobile" class="form-control {{ $memberEdit->telephone_mobile_edited ? 'border border-danger' : '' }}" value="{{ $membership->telephone_mobile ? : '-'}}">
                                    </div>
                                </div>
                                <div class="col-6 row">
                                    <label for="telephone_home" class="col-sm-4 col-form-label">Landline Number</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="telephone_home" class="form-control {{ $memberEdit->telephone_home_edited ? 'border border-danger' : '' }}" value="{{ $membership->telephone_home ? : '-'}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <div class="card-body">
                            <div class="col-md-6 text-right">
                                ...
                                <button type="submit" name="approval" value="approve" class="btn btn-primary">Approve</button>
                                @endcan
                                @can('memberships-rejected-reject')
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#rejectModal" @if ($membership->rejectedl2 == 1) disabled @endif>Reject</button>
                                @endcan
                            </div>
                        </div>
                    </form>
                ...
                <form action="{{ route('approval', ['membership' => $membership->id]) }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <textarea class="form-control" name="fwd_to_reason" id="fwd_to_reason" rows="4" required></textarea>
                        </div>
