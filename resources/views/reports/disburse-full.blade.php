        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <h4 class="text-center mt-1"> Full Withdrawal Bank Deposit List</h4>
                </div>
            </div>
            <div class="container-fluid">
                <div class="card p-3">
                    <div class="row">
                        @if ($fullWithdrawals->count() > 0)
                            ...
                            <table class="table table-bordered table-secondary">
                                ...
                                @foreach ($fullWithdrawals as $fullWithdrawal)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $fullWithdrawal->membership->regiments->regiment_name ?? '--' }}</td>
                                        <td class="text-right">{{ number_format($fullWithdrawal->fullWithdrawal->withdrawal_amount, 2) }}</td>
                                    </tr>
                                @endforeach
                                <tr>
                        ...
                        <div class="modal-content">
                            <form action="{{ route('partial.banked') }}" method="POST">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <label class="col-form-label text-center">Withdrawal Amounts deposit to bank</label>
                                    </div>
                                </div>
