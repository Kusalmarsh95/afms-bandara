...
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 margin-tb text-center p-0 mb-2">
                    <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                        <h3>New Withdrawal - {{$membership->ranks->rank_name ?? '-'}} {{ $membership->name}}</h3>
                                                        ...
                                                        @if ($suwasahana)
                                                            ...
                                                            @else
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-6 row">
                                                                        <label for="suwasahana_arreas" class="col-sm-6 col-form-label">Arrears</label>
                                                                        <div class="col-sm-6">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-6 row">
                                                                ...
                                                                <div class="col-sm-7">
                                                                    <input type="text" name="requested_amount" id="requestedAmount" class="form-control" value="0.00">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-6 row">
                                                                <label for="purpose" class="col-sm-5 col-form-label">Purpose <i class="nav-icon fas fa-exclamation-circle text-red"></i></label>
                                                                <div class="col-sm-7">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var suwasahanaInterestInput = document.querySelector('input[name="suwasahana_arreas"]');

            nextButton.disabled = true;

            var eligibleAmount; // base eligible amount (calculatedAmount - dues)
            ...
            // Recalculate eligible amount factoring in interest inputs
            function recalcEligibleAmount() {
                ...
                // Update loanEligibility badge accordingly
            ...
            genderSelect.addEventListener('change', function () {
                withdrawalProductSelect.selectedIndex = 0;

                document.getElementById('selectedServiceStatus').innerHTML = '';
                document.getElementById('loanEligibility').innerHTML = '';
            ...
            withdrawalProductSelect.addEventListener('change', function () {
                ...
                var maleService = selectedOption.getAttribute('data-male-service');
                var femaleService = selectedOption.getAttribute('data-female-service');
                var selectedGender = genderSelect.value;
                var selectedService = (selectedGender === '1') ? maleService : ((selectedGender === '0') ? femaleService : '');
                var difference = {{ $armyService }};
                var selectedServiceStatusElement = document.getElementById('selectedServiceStatus');

                if (selectedService === '') {
                    selectedServiceStatusElement.innerHTML = '';
                } else if (difference >= selectedService) {
                    selectedServiceStatusElement.innerHTML = '<span class="badge badge-success mt-2" style="height: 20px!important"><i class="fas fa-check"></i>Satisfied</span>';
                } else {
                    selectedServiceStatusElement.innerHTML = '<span class="badge badge-danger mt-2" style="height: 20px!important"><i class="fas fa-times"></i> Dissatisfied</span>';
                }
                ...
                $('#calculatedAmount').val(formatAmount(calculatedAmount));
                $('.calculatedAmount').val(calculatedAmount.toFixed(2));

                // Initialize display with base eligibleAmount before interest inputs
                updateEligibleAmountDisplay(eligibleAmount);

                // Initially update loan settlement badge based on base eligible amount
                var loanSettlementInput = $('#loanSettlement');
                var loanEligibility = document.getElementById('loanEligibility');
            ...
            // Attach input event listeners to interest inputs if present
            ...
            submitData.addEventListener('click', function() {
                ...
                if (purposeInput.value === 'Select Purpose') {
                    alert('Please select the purpose');
                    location.reload();
                } else if (requestedAmount > eligibleAmount) {
                    alert('Requested amount exceeds the maximum allowable amount');
                    event.preventDefault();
                    location.reload();
                }
            });
