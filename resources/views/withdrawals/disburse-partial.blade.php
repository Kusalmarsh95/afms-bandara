...
@section('content')
    <div class="container-fluid">
        ...
        @endif
        <form id="withdrawal" action="{{ route('partial-disburse', $partialWithdrawal->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-6 row">
                            ...
                            <div class="col-sm-7">
                                <input type="hidden" name="membership_id" class="form-control" value="{{ $partialWithdrawal->membership->id }}">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-6 row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="account_no" class="form-control" value="{{ $partialWithdrawal->withdrawal->account_no ?? '-' }}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-6 row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="bank_name" class="form-control" value="{{$partialWithdrawal->withdrawal->bank_name ?? '-' }}" readonly>
                            </div>
                        </div>
                        <div class="col-6 row">
                            <label for="branch_name" class="col-sm-4 col-form-label">Branch Name</label>
                            <div class="col-sm-8">
                                <input type="text" id="branch_name" class="form-control" value="{{ $partialWithdrawal->withdrawal->branch_name ?? '-' }}" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-6 row">
                            ...
                            <div class="col-sm-8">
                                <input type="hidden" name="loan_due_cap" class="form-control" value="{{ $partialWithdrawal->withdrawal->loan_due_cap ?? '0.00' }}">
                                <input type="text" class="form-control" value="{{ number_format($partialWithdrawal->withdrawal->loan_due_cap) ?? '0.00' }}" readonly>
                            </div>
                        </div>
                        <div class="col-6 row">
                            <label for="arrest_interest" class="col-sm-4 col-form-label">Arrears Interest</label>
                            <div class="col-sm-8">
                                <input type="hidden" name="arrest_interest" class="form-control" value="{{ $partialWithdrawal->withdrawal->arrest_interest ?? '0.00' }}" readonly>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-6 row">
                            <label for="loan_10_month" class="col-sm-4 col-form-label">Suwasahana Arrears</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="{{ number_format($partialWithdrawal->withdrawal->suwasahana_arreas, 2) ?? '0.00' }}" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-12 row">
                            <label for="fund_balance" class="col-sm-2 col-form-label">Purpose</label>
                            <div class="col-sm-10">
                                ...
                                @elseif($partialWithdrawal->withdrawal->purpose==2)
                                    <input type="text" class="form-control" value="Settle the Suwasahana amount" readonly>
                                @else
                        ...
                        <div class="col-6 row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="approved_amount"
                                       value="{{ number_format($partialWithdrawal->withdrawal->approved_amount, 2) ?? '0.00' }}" readonly>
                            </div>
                        </div>
                        <div class="col-6 row">
                            <label for="requested_amount" class="col-sm-4 col-form-label">Requested Amount</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="{{ number_format($partialWithdrawal->withdrawal->requested_amount,2) ?? '' }}" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-6 row">
                            <label for="voucher_no" class="col-sm-4 col-form-label">Voucher No</label>
                            <div class="col-sm-8">
                                <input type="text" name="voucher_no" class="form-control" value="{{ $partialWithdrawal->withdrawal->voucher_no ?? '' }}">
                            </div>
                        </div>
                        <div class="col-6 row">
                            <label for="voucher_amount" class="col-sm-4 col-form-label">Voucher Amount</label>
                            <div class="col-sm-8">
                                <input type="hidden" name="voucher_amount" class="form-control" value="{{ $partialWithdrawal->withdrawal->approved_amount }}">
                                <input type="text" class="form-control" value="{{number_format($partialWithdrawal->withdrawal->approved_amount, 2) ?? '0.00'}}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-6 row">
                            <label for="total_withdraw_amount" class="col-sm-4 col-form-label">Withdrawal Amount</label>
                            <div class="col-sm-8">
                                <input type="hidden" class="form-control" name="total_withdraw_amount" value="{{ $withdrawAmount  }}">
                                <input type="text" class="form-control" value="{{ number_format($withdrawAmount,2) ?? '0.00' }}" readonly>
                            </div>
                        </div>
                    </div>
                </div>
...
{{--                            @endcan--}}
                            @can('withdrawals-partial-reject')
                                <button type="button" class="btn btn-sm btn-outline-danger  m-2" data-toggle="modal" data-target="#rejectModal" @if ($partialWithdrawal->processing == 2) disabled @endif>Reject</button>
                            @endcan
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="rejectModal" tabindex="-1" role="dialog" aria-labelledby="rejectModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ route('partial-disburse', $partialWithdrawal->id) }}" method="POST">
                    @csrf
                    @method('PUT')
