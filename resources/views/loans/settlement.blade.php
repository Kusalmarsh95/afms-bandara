    ...
    <div class="container-fluid">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h3><strong>Loan Settlement Details</strong></h3>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-6 row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="date" class="form-control" value="{{ $loan ? (new DateTime($lastPaymentDate))->format('Y-m-d') : '' }}" readonly style="color: red;">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                                    ...
                                                    <table class="table table-bordered" id="contributionTable">
                                                        ...
                                                        @foreach ($repaymentSchedule as $repayment)
                                                            <tr>
                                                                ...
                                                                <td>{{ $repayment['repayment_data']['payment_date'] ?? 'NA'}}</td>
